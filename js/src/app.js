define([
    ...
    // './filters/index',
    // './services/index'
], function ($,ng,app,controllers) {
    'use strict';

    console.log("script.js here.");
    ...
    var mvolzApp = ng.module('app', ['ngRoute']);

    // configure our routes
    

    // create the controller and inject Angular's $scope
    app.controller('mvolzController', function($scope) {
        d3blocks();
    });
    ...
    console.log("script.js completing.");
